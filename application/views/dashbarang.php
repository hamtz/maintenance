                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            ...
                            <ul class="nav nav-treeview ">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url() ?>datadata/barang" class="nav-link active">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td onclick="javascript: return confirm('Yakin ingin menghapus?')"> <?php echo anchor('datadata/delete_barang/' . $data->id_barang, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                                                <td> <?php echo anchor('datadata/edit_barang/' . $data->id_barang, '<div class=" btn btn-info btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                                            </tr>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo form_open_multipart('datadata/insert_barang'); ?>
