                                ...
                                <div class="card-body">
                                    ...
                                    <form action=" <?php echo base_url() . 'dashboard/insert'; ?>" method="post">
                                        <div class="form-group row">
                                            ...
                                            <input type="text" name="no_mt" class="form-control col-4 " value="<?php echo $data->no_mt ?>" readonly>
                                            <input type="hidden" name="id_mt" class="form-control" value="<?php echo $data->id_mt ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-4">tanggal</label>
                                            <input type="date" name="tgl_mt" class="form-control col-4" value="<?php echo $data->tgl_mt ?>">
                                        </div>
                                        <div class=" form-group row">
                                            <label class="col-4">Petugas 1</label>
                                            <select class="form-control col" name="petugas1">
                                                <option> <?php echo $data->petugas1 ?> </option>
                                                <?php
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <select class="form-control col" name="petugas2">
                                                <option> <?php echo $data->petugas2 ?> </option>
                                                <?php
                                                foreach ($listpegawai as $row) {
                                                    echo '<option value="' . $row->nama_pegawai . '">' . $row->nama_pegawai . '</option>';
                                                }
                                        ...
                                        <div class="form-group row">
                                            <label class="col-4">Nama Barang</label>
                                            <input type="text" name="nama_barang" id="namabarang" class="form-control col" value="<?php echo $data->nama_barang ?>">
                                        </div>

                                        <div class="form-group row">
                                            <label class="col-4">Kode Barang</label>
                                            <input type="text" name="kode_barang" class="form-control col" value="<?php echo $data->kode_barang ?>">
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-4">Deskripsi</label>
                                            <textarea name="deskripsi" class="form-control col" rows="3"><?php echo $data->deskripsi ?></textarea>
                                        </div>
                                        <!-- <button type="reset" class="btn btn-danger">Reset</button> -->
                                        <div class="row">
                                            <div class="col-4"></div>
                                            <div class="col"><button type="submit" class="btn btn-success">Simpan</button>
                                                <a href="<?php echo base_url('dashboard/list'); ?>" class="btn btn-primary">Kembali</a>
                                            </div>
                                        </div>
                                    </form>
