                                    ...
                                    <table class="table table-striped">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td onclick="javascript: return confirm('Yakin ingin menghapus?')"> <?php echo anchor('datadata/delete_pegawai/' . $data->id_pegawai, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                                                <td> <?php echo anchor('datadata/edit_pegawai/' . $data->id_pegawai, '<div class=" btn btn-info btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                                            </tr>
